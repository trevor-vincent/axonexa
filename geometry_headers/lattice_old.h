	...
	The main parent class Lattice. It serves as only a label so that the user can choose the specific type of
	lattice at runtime and allow me to still make generic routines for only Lattice but still use them for the
