...
public:
  ...
  __device__ __host__ Cylinder_XY(real _centerX, real _centerY, real _radius, real _T2, real _T1, real _D, int _region, real _permeability){
    centerX = _centerX;
    centerY = _centerY;
    radius = _radius;
    D = _D;
  ...
  __device__ __host__ Cylinder_XY(real _centerX, real _centerY, real _radius, real _T2, real _T1, real _D, int _region, real _permeability, real _eps){
    centerX = _centerX;
    centerY = _centerY;
    radius = _radius;
    D = _D;
