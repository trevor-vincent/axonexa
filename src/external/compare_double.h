...
Floating point comparison (specificially double precision) comparison needs to
be done by using subtraction and a tolerance These methods are used
semi-frequently throughout the code and are thus made inline to speed up
runtime.
