/***************************************************************************************
        ...
        For a more detailed explanation, read the corresponding section in
 Numerical Recipes or the Wikipedia article on the quadratic equation.

        or the famous article:

        What Every Computer Scientist Should Know About Floating-Point
 Arithmetic, by David Goldberg, published in the March, 1991 issue of Computing
 Surveys. Copyright 1991, Association for Computing Machinery, Inc., reprinted
 by permission.
 ****************************************************************************************/
