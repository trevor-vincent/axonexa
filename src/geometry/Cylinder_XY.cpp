...
Cylinder_XY::Cylinder_XY(double _center_x, double _center_y, double _radius,
                         double _T2, double _D, int _region) {
...
bool Cylinder_XY::intersect(Line &line, double &v) {
    ...
    c = xi * xi + yi * yi - 2 * xi * l_x - 2 * yi * l_y + l_x * l_x +
        l_y * l_y - radius * radius;
